...
A Dani é de Piracicaba-SP (e do IEL), mas faz envios para todo o Brasil. As formas de pagamento são: PIX, transferência e boleto.{: .text-justify}
...
O Giovanne Lima é um artista do IEL. Vocês podem encontrá-lo no Instagram como @zorin_.{: .text-justify}
...
O Lucas Dantas é um artista do IMECC. Vocês podem encontrá-lo no Instagram como @macavitybr.{: .text-justify}
